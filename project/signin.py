...
def fbConnect():
    ...
    url = 'https://graph.facebook.com/oauth/access_token?grant_type=fb_exchange_token&client_id=%s&client_secret=%s&fb_exchange_token=%s'   # NDQA 
          % (FB_ID, FB_SCRT, access_token)
    h = httplib2.Http()
